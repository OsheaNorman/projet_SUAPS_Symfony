...
$a->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\ServiceLocator(array('App\\Repository\\CarteRepository' => function () {
    return ($this->privates['App\Repository\CarteRepository'] ?? $this->load('getCarteRepositoryService.php'));
}, 'App\\Repository\\EtudRepository' => function () {
    return ($this->privates['App\Repository\EtudRepository'] ?? $this->load('getEtudRepositoryService.php'));
}, 'App\\Repository\\TestRepository' => function () {
    return ($this->privates['App\Repository\TestRepository'] ?? $this->load('getTestRepositoryService.php'));
}, 'App\\Repository\\VuePresenceRepository' => function () {
    return ($this->privates['App\Repository\VuePresenceRepository'] ?? $this->load('getVuePresenceRepositoryService.php'));
}))));
