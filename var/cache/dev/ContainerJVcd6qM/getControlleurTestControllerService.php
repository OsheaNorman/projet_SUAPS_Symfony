...
$this->services['App\Controller\ControlleurTestController'] = $instance = new \App\Controller\ControlleurTestController(($this->services['doctrine.dbal.default_connection'] ?? $this->load('getDoctrine_Dbal_DefaultConnectionService.php')));
