...
$a->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\ServiceLocator(array('App\\Repository\\AuaExterieurSportRepository' => function () {
    return ($this->privates['App\Repository\AuaExterieurSportRepository'] ?? $this->load('getAuaExterieurSportRepositoryService.php'));
}, 'App\\Repository\\AuaPresenceSeanceRepository' => function () {
    return ($this->privates['App\Repository\AuaPresenceSeanceRepository'] ?? $this->load('getAuaPresenceSeanceRepositoryService.php'));
}))));
