...
// Returns the private 'App\Repository\AuaExterieurSportRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/AuaExterieurSportRepository.php';

return $this->privates['App\Repository\AuaExterieurSportRepository'] = new \App\Repository\AuaExterieurSportRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
