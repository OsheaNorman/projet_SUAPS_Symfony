...
// Returns the private 'App\Repository\AuaPresenceSeanceRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/AuaPresenceSeanceRepository.php';

return $this->privates['App\Repository\AuaPresenceSeanceRepository'] = new \App\Repository\AuaPresenceSeanceRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
