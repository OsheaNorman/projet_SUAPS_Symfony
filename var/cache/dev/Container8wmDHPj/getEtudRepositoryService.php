...
// Returns the private 'App\Repository\EtudRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/EtudRepository.php';

return $this->privates['App\Repository\EtudRepository'] = new \App\Repository\EtudRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
