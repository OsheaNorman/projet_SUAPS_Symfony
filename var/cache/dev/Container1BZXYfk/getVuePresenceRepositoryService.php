...
// Returns the private 'App\Repository\VuePresenceRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/VuePresenceRepository.php';

return $this->privates['App\Repository\VuePresenceRepository'] = new \App\Repository\VuePresenceRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
